...
const ServiseCard = ({ Service, index }) => {
  ...
  const handleMouseMove = (e) => {
    const bounds = divRef.current.getBoundingClientRect(); // ✅ fixed
    setPosition({
  ...
  return (
    ...
    >
      ...
      from-blue-500 via-indigo-500 to-purple-500 w-[300px] h-[300px] absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? "opacity-70" : "opacity-0"}`}
        style={{
