...
const Teams = () => {
  return (
    <div className=" flex flex-col items-center  gap-7 px-4 sm:px-12  lg:px-24 xl:px-40 placeholder-teal-300 text-gray-800 dark:text-white ">
      <Title
        title={"Meet the team"}
        desc={
  ...
  {teamData.map((team, index) => (
    <div
      key={team.name}  // better than index
